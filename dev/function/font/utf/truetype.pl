...
my @bounds = $im->stringFT(2, $agenda,   11, 0, 30,  30,   'agenda äöü 艾勒');
$mu->record('1st');
             $im->stringFT(2, $bkl,      11, 0, 30,  50,   'bkl äöü 艾勒');
$mu->record('2st');
             $im->stringFT(2, $gothic,   11, 0, 30,  70,   'gothic äöü 艾勒');
$mu->record('3st');
             $im->stringFT(2, $copper,   11, 0, 30,  90,   'copper äöü 艾勒');
$mu->record('4st');
             $im->stringFT(2, $futurama, 11, 0, 30, 110,   'futurama äöü 艾勒');
$mu->record('5st');
             $im->stringFT(2, $agenda,   11, 0, 30, 130,   'agenda äöü 艾勒');
$mu->record('5st');

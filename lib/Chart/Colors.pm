...
# Chart::Color :  expandable store of all predefined color names

use v5.12;

package Chart::Colors;

my @all_names = qw (red green blue purple peach orange mauve olive pink light_purple light_blue plum yellow turquoise light_green brown

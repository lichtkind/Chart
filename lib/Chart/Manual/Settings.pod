...
Chart::Manual::Settings - Complete Guide to Chart Settings

=head1 INTRO

Once a Chart - object is created, you can change individual properties
with the method C<set>
 allows to directly change particular chart properties.
All these properties sorted by name or topic or type with their

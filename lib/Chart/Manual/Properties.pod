...
Anonymous subroutines that usually react to the firt argument given like:
...
L</png_border> ...... L<pos_int|/"positive integer">: space between graph and image edge in pixel; C<10>
...
L</integer_ticks_only>  L<bool|/boolean>: draw tick label as int; C<'false'>

L</precision> ....... L<pos_int|/"positive integer">: nr. of numerals after the decimal point in axis labels; C<3>

L</skip_int_ticks> .. L<pos_int|/"positive integer">: every n'th tick will be drawn; C<1>
...
L</graph_border> ..... space between graph and surrounding box in pixel; C<10>

L</label_values> ..... qw[percent value both none]: label content on pie slice value; C<'percent'>

L</legend_label_values> .. qw[percent value both none]: labels content in the legend; C<'value'>

...
which name what exactly you need to color. Their value has to be a L<color>
...
for making web page images.  Default is C<'false'>.
...
L</grey_background> . L<bool|/boolean>: plot background set to grey; C<'true'>
...
L</legend_font> ..... L</font> of the text in the legend. 
...
Properties available in all chart types except L</Pie>:

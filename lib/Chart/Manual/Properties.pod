...
a GD font object as an argument. Default is C<GD::Font->Small>
...
This option changes the L</font> of the title. Default is C<GD::Font->Large>.
...
L<color-background|/colors> .. L</color> of whole image background ; C<'white'>

L<color-datasetx|/colors> .... L</color> of points/lines/bars of dataset number x = 0..64

L<color-grid_lines|/colors> .. L</color> of vertical and horizontal grid lines in the plot background; C<'black'>

L<color-x_grid_lines|/colors>  L</color> of vertical grid lines; C<'black'>

L<color-y_grid_lines|/colors>  L</color> of horizontal grid lines; C<'black'>

L<color-text|/colors> ........ L</color> of all text ; C<'black'>

L<color-title|/colors> ....... L</color> of text above the graph ; C<'black'>

L<color-x_label|/colors> ..... L</color> of x-axis label text; C<'black'>

L<color-y_label|/colors> ..... L</color> of y-axis (left side) label text; C<'black'>

L<color-y_label2|/colors> .... L</color> of y-axis (right side) label text; C<'black'>

L<color-misc|/colors> ........ L</color> of boxes, ticks, axis and alike; C<'black'>
...
L</legend_font> ..... L</font> of the text in the legend; C<GD::Font->Small>.
...
L</title_font> ...... L</font> of the title text; C<GD::Font->Large>

L</transparent> ..... L<bool|/boolean>: full image background transparency; C<'false'>

L</x_label> ......... L</string>: x-axis label text; C<''>

L</y_label> ......... L</string>:labels on the standard, left y-axis; C<''>
...
L</tick_label_font> . L</font> of tick labels; C<GD::Font->Small>

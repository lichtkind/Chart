...
the second set (30000) is positioned above the first tick on the x-axis
labeled 'camel'. Right beside it is a differently colored bar, depticting
the first value of the third data set (80000). Since the option L<spaced_bars|Chart::Manual::Properties/spaced_bars>
